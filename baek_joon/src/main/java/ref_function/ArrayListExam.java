...
import java.util.Collections; // static이어서 객체 안 만들어도 사용가능
...
public class ArrayListExam {
    public static void main(String[] args) {
        //배열의 길이를 정하지 않고도 배열을 만들 수 있다.
        // 장점1 배열에 값을 넣으면 배열의 크기가 자동으로 증가한다.
        // 장점2 다양한 함수를 사용할 수 있다.
        // ex) max와min으로 배열에서 최대 최소를 알 수 있다.
        // ex) binarySeach로 배열에서 특정값 찾기
